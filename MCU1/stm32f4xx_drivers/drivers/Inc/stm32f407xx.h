...
// Base address of peripheral buses
...
// Base addresses of peripheral which are connected to AHB1 bus
...
// Base addresses of peripheral which are connected to APB1 bus
...
// Base addresses of peripheral which are connected to APB2 bus
...
// Peripheral structure definition register
// order of these registers should match with offset from base address of GPIO port
typedef struct
{
	__vo uint32_t MODER;
...
#define GPIOA_REG_RESET()   do{(RCC->AHB1RSTR|=(1<<0)); (RCC->AHB1RSTR &=~(1<<0));}while(1)
#define GPIOB_REG_RESET()   do{(RCC->AHB1RSTR|=(1<<1)); (RCC->AHB1RSTR &=~(1<<1));}while(1)
#define GPIOC_REG_RESET()   do{(RCC->AHB1RSTR|=(1<<2)); (RCC->AHB1RSTR &=~(1<<2));}while(1)
#define GPIOD_REG_RESET()   do{(RCC->AHB1RSTR|=(1<<3)); (RCC->AHB1RSTR &=~(1<<3));}while(1)
#define GPIOE_REG_RESET()   do{(RCC->AHB1RSTR|=(1<<4)); (RCC->AHB1RSTR &=~(1<<4));}while(1)
#define GPIOF_REG_RESET()   do{(RCC->AHB1RSTR|=(1<<5)); (RCC->AHB1RSTR &=~(1<<5));}while(1)
#define GPIOG_REG_RESET()   do{(RCC->AHB1RSTR|=(1<<6)); (RCC->AHB1RSTR &=~(1<<6));}while(1)
#define GPIOH_REG_RESET()   do{(RCC->AHB1RSTR|=(1<<7)); (RCC->AHB1RSTR &=~(1<<7));}while(1)
#define GPIOI_REG_RESET()   do{(RCC->AHB1RSTR|=(1<<8)); (RCC->AHB1RSTR &=~(1<<8));}while(1)

// Macros to reset SPIx peripherals
#define SPI1_RESET()   		do{(RCC->APB2RSTR|=(1<<12));  (RCC->APB2RSTR &=~(1<<12));}while(1)
#define SPI2_RESET()   		do{(RCC->APB1RSTR|=(1<<14)); (RCC->APB1RSTR &=~(1<<14));}while(1)
#define SPI3_RESET()   		do{(RCC->APB1RSTR|=(1<<15)); (RCC->APB1RSTR &=~(1<<15));}while(1)
